...
function init() {
  ...
  function onResourcesLoaded(){
    ...
    for(var i = 0; i<TREE_COUNT;i++){
      ...
      while(true){
        var randomX = getRandomArbitrary(-MAP_SIZE_W,MAP_SIZE_W);
        var randomZ = getRandomArbitrary(-MAP_SIZE_H,MAP_SIZE_H);
  ...
  for(var i=0;i<ENEMY_COUNT;i++){
    while(true){
      var randomX = Math.floor(getRandomArbitrary(-MAP_SIZE_W,MAP_SIZE_W));
      var randomZ = Math.floor(getRandomArbitrary(-MAP_SIZE_H,MAP_SIZE_H));
